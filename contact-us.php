            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <div class="contact-info-left">
                        <h2>CONTACT INFO</h2>
                        <p>is a store that prioritizes product quality, RJ.ID has the slogan that prospective buyers are comfortable shopping at our leaders by providing the best quality products and services for potential buyers</p>
                        <ul>
                            <li>
                                <p><i class="fas fa-map-marker-alt"></i>Address: Jl.Perintis No 71 <br>Kota Bau-Bau,<br> kode pos 93724 </p>
                            </li>
                            <li>
                                <p><i class="fas fa-phone-square"></i>Phone: <a href="https://wa.me/qr/ZXM5LFYHUI4QN1"> 62+ 082344068300</a></p>
                            </li>
                            <li>
